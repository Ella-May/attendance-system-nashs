                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Security Personnel / Clinic Table</h6>
                        </div>
                    </div>
                    <div class="card-body pb-2">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                        @isset($schoolClinics)
                                            @foreach ($schoolClinics as $schoolClinic)
                                            <tr>
                                                <td>
                                                    <p class="text-center text-xs font-weight-bold mb-0 ps-3">{{ $schoolClinic->ar_studentname }}</p>
                                                </td>
                                                <td>
                                                    <p class="text-center text-xs font-weight-bold mb-0 ps-3">
                                                        {{ $schoolClinic->ar_gradelvl.' - '. $schoolClinic->ar_section }}
                                                    </p>
                                                </td>
                                                <td>
                                                    <p class="text-center text-xs font-weight-bold mb-0">
                                                        {{ date('F d, Y', strtotime($schoolClinic->ar_date)) }}
                                                    </p>
                                                </td>
                                                <td>
                                                    <p class="text-center text-xs font-weight-bold mb-0">
                                                        {{ date('h:i A', strtotime($schoolClinic->ar_date)) }}
                                                    </p>
                                                </td>
                                                <td>
                                                    <p class="text-center text-xs font-weight-bold mb-0">
                                                        {{ Str::ucfirst(($schoolClinic->ar_department)) }}
                                                    </p>
                                                </td>
                                            </tr>
                                            @endforeach
        ...
        <div class="row">
            <div class="col-12">
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Faculty Member</h6>
                        </div>
                    </div>
                    <div class="card-body pb-2">
                        <div class="table-responsive p-0">
