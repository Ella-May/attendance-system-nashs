                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Subject Information Table</h6>
                        </div>
                    </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                            <form method="POST" action="{{ route('subject-info.store') }}" id="facultyLoadForm">
                                                @csrf
                                                <div class="mb-3 row">
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <p class="text-xs font-weight-bold mb-0">
                                                        {{ date('h:i A', strtotime($subject->sub_timestart)).' - '.date('h:i A', strtotime($subject->sub_timeend)) }}
                                                    </p>
                                                </td>
                                                <td class="align-middle text-center text-sm">
                                                    <div class="ms-auto text-end">
                                                        ...
                                                        <div class="modal fade" id="viewModal{{ $subject->id }}" tabindex="-1" role="dialog" aria-labelledby="viewModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                              <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title"><i class="material-icons text-m py-2">info</i> Subject Information</h5>
                                                        ...
                                                        <a class="btn btn-link text-dark px-1 mb-0" href="{{ route('subject-info.edit', ['id' => $subject->id ]) }}">
                                                              ...
                                                              <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                  <a class="btn btn-link text-dark text-gradient px-1 mb-0" data-bs-dismiss="modal">Close</a>
                                                                    ...
                                                                    <form action="{{ route('subject-info.delete', ['id' =>  $subject->id]) }}" method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
