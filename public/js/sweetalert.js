...
scanner.addListener('scan', function (content) {
  ...
  formData.append('time', moment_moment__WEBPACK_IMPORTED_MODULE_1___default()().unix());
  ...
  setTimeout(function () {
    fetch('https://attendance-system-nashs.test/attendance-report', {
      ...
      if (data.status == "error" || data.message == "An error has occured!") {
        ...
        var timeRecord = "\n                        <div>\n                            <h5>Name: ".concat(data.ar_studentname, "</h5>\n                            <p>Date and Time: ").concat(moment_moment__WEBPACK_IMPORTED_MODULE_1___default()(data.ar_date).format('MMMM Do YYYY'), " at ").concat(moment_moment__WEBPACK_IMPORTED_MODULE_1___default()(data.ar_time).format('h:mm A'), "</p>\n                            ").concat(data.ar_department ? '<p>Department: ' + data.ar_department + '</p>' : '', "\n                            ").concat(data.ar_subject ? '<p>Subject: ' + data.subject + '</p>' : '', "\n                        </div>\n                    ");
        sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
          icon: 'success',
          title: 'Time Recorded',
          html: timeRecord
...
Instascan.Camera.getCameras().then(function (cameras) {
  if (cameras.length > 0) {
    var buttonScanner = document.getElementById('scanQRCode');
